...
if __name__ == '__main__':
    ...
    trip_data = tp.tripmodule.tripdata(db) # fetch one trip to analyse
    exist_un_cyclepath_data = cpm.cyclepathmodule.cycledata(db) # fetch all cyclepaths
    ...
    if nm_failed_flag:
        ...
        list_exist,list_unexist,json_exist = distanceObject.getdata(trip_data,exist_un_cyclepath_data)
